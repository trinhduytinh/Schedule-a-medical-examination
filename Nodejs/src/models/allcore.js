...
module.exports = (sequelize, DataTypes) => {
  class Allcode extends Model {
    ...
    static associate(models) {
      ...
      // Allcode.hasMany(models.User, { foreignKey: 'remote', as: 'remoteData'})
      ...
      Allcode.hasMany(models.Doctor_Infor, { foreignKey: 'remote', as: 'remoteTypeData'})
      Allcode.hasMany(models.Booking, { foreignKey: 'timeType', as: 'timeTypeDataPatient'})
      Allcode.hasMany(models.Booking, { foreignKey: 'statusId', as: 'statusPatient'})
    }
  }
  Allcode.init(
    {
