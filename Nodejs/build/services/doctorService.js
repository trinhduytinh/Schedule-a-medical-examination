...
var getTopDoctorHome = function getTopDoctorHome(limit) {
  return new Promise( /*#__PURE__*/function () {
    var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(resolve, reject) {
      var users, endDate, startDate, bookingCounts, doctorBookingCounts, doctors;
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          ...
          case 4:
            ...
            break;
          case 8:
            endDate = Date.now(); // Timestamp của ngày hiện tại
            startDate = endDate - 7 * 24 * 60 * 60 * 1000; // Timestamp của ngày 7 ngày trước đó
            _context.next = 12;
            return _index["default"].Booking.findAll({
              where: {
                statusId: "S3",
                date: _defineProperty({}, _index["default"].Sequelize.Op.between, [startDate, endDate])
              },
              attributes: ["doctorId", [_index["default"].Sequelize.fn("COUNT", "doctorId"), "bookingCount"]],
              group: ["doctorId"],
              raw: true
            });
          case 12:
            bookingCounts = _context.sent;
            // Tạo một object để lưu số lần đặt lịch của mỗi bác sĩ
            doctorBookingCounts = {}; // Lặp qua kết quả đếm số lần đặt lịch của mỗi bác sĩ và lưu vào object doctorBookingCounts
            bookingCounts.forEach(function (booking) {
          ...
          case 21:
            ...
            return _index["default"].User.findAll({
              where: {
                id: Object.keys(doctorBookingCounts),
                // Chỉ lấy các bác sĩ có trong danh sách doctorBookingCounts
                roleId: "R2"
              },
              limit: +limit,
              // Sử dụng giới hạn nếu được truyền vào, ngược lại không có giới hạn
              attributes: {
                exclude: ["password"]
              },
              include: [{
...
var saveDetailInforDoctor = function saveDetailInforDoctor(inputData) {
  return new Promise( /*#__PURE__*/function () {
    var _ref3 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee3(resolve, reject) {
      var checkObj, contentHTMLEn, contentHTMLJa, descriptionEn, descriptionJa, addressClinicEn, addressClinicJa, nameClinicEn, nameClinicJa, noteEn, noteJa, translationHTMLen, translationHTMLja, translationDescen, translationDescja, translationAddressClinicEn, translationAddressClinicJa, translationNameClinicEn, translationNameClinicJa, translationNoteEn, translationNoteJa, doctorMarkdown, doctorInfor;
      return _regeneratorRuntime().wrap(function _callee3$(_context3) {
        while (1) switch (_context3.prev = _context3.next) {
          case 0:
            ...
            break;
          case 6:
            contentHTMLEn = "", contentHTMLJa = "", descriptionEn = "", descriptionJa = "", addressClinicEn = "", addressClinicJa = "", nameClinicEn = "", nameClinicJa = "", noteEn = "", noteJa = "";
            _context3.prev = 7;
            _context3.next = 10;
            return (0, _bingTranslateApi.translate)(inputData.contentHTML, null, "en");
          case 10:
            translationHTMLen = _context3.sent;
            contentHTMLEn = translationHTMLen.translation;
            _context3.next = 14;
            return (0, _bingTranslateApi.translate)(inputData.contentHTML, null, "ja");
          case 14:
            translationHTMLja = _context3.sent;
            contentHTMLJa = translationHTMLja.translation;
            _context3.next = 18;
            return (0, _bingTranslateApi.translate)(inputData.description, null, "en");
          case 18:
            translationDescen = _context3.sent;
            descriptionEn = translationDescen.translation;
            _context3.next = 22;
            return (0, _bingTranslateApi.translate)(inputData.description, null, "ja");
          case 22:
            translationDescja = _context3.sent;
            descriptionJa = translationDescja.translation;
            _context3.next = 26;
            return (0, _bingTranslateApi.translate)(inputData.addressClinic, null, "en");
          case 26:
            translationAddressClinicEn = _context3.sent;
            addressClinicEn = translationAddressClinicEn.translation;
            _context3.next = 30;
            return (0, _bingTranslateApi.translate)(inputData.addressClinic, null, "ja");
          case 30:
            translationAddressClinicJa = _context3.sent;
            addressClinicJa = translationAddressClinicJa.translation;
            _context3.next = 34;
            return (0, _bingTranslateApi.translate)(inputData.nameClinic, null, "en");
          case 34:
            translationNameClinicEn = _context3.sent;
            nameClinicEn = translationNameClinicEn.translation;
            _context3.next = 38;
            return (0, _bingTranslateApi.translate)(inputData.nameClinic, null, "ja");
          case 38:
            translationNameClinicJa = _context3.sent;
            nameClinicJa = translationNameClinicJa.translation;
            _context3.next = 42;
            return (0, _bingTranslateApi.translate)(inputData.note, null, "en");
          case 42:
            translationNoteEn = _context3.sent;
            noteEn = translationNoteEn.translation;
            _context3.next = 46;
            return (0, _bingTranslateApi.translate)(inputData.note, null, "ja");
          case 46:
            translationNoteJa = _context3.sent;
